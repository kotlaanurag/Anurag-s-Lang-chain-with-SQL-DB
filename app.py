...
st.set_page_config(page_title="Anurag,s Lang chain :chat with SQL DB",page_icon=">>>>")
st.title("Anurag's Lang chain with SQL DB")
...
if not api_key:
    st.info("please add the grooq api key")
